<template>
    <div class="wrap">
        <b-jumbotron class="p-3">
            <b-container class="d-flex justify-content-between" style="height: 300px">
                <div style="max-width: 70%" class="h-100 d-flex justify-content-center flex-column">
                    ...
                    <b-button variant="info" style="max-width: 200px" to="/files/mn_2021.pdf" target="_blank">Спушти документ</b-button>
        ...
        <b-container id="statistic">
            <h3 class="mt-4">Број на договори по месец (вкупно договори: {{getSum(poMesec)}})</h3>
            <column-chart :data="poMesec" :download="true"></column-chart>
            <h3 class="mt-4">Постапки на договори (вкупно постапки: {{poVid.length}})</h3>
