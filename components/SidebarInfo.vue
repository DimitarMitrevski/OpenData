<template>
  <div class="info-sidebar">
    ...
    >
      ...
      <div
        class="d-flex flex-column justify-content-center align-items-center h-100 wrap-side p-3"
      >
        <div class="infwrapper">
          <h4 class="text-center">
            <nuxt-link to="/municipality"
              >Општина {{ content ? content.name : 'Sidebar' }}</nuxt-link
            >
          </h4>
          ...
          <div class="table-wrap">
            <b-table
              striped
              hover
              :items="[{ Број_на_жители: 11890, Регион: 'Југоисточен' }]"
            ></b-table>
          </div>
          <div class="chart-wrap" v-if="content.prihodi && content.rashodi">
            <column-chart
              ...
              :colors="['#74dace']"
              :data="[
                [`Приходи:`, content.prihodi],
                [`Расходи:`, content.rashodi],
              ]"
            ></column-chart>
          </div>
          <b-button
            ...
            >Симни го буџетот <b-icon icon="download"></b-icon
          ></b-button>
          <b-button
            class="d-block mt-4 mx-auto btn-info"
            size="lg"
            to="/municipality"
            >Повеќе...</b-button
          >
      ...
      <template #footer="{ hide }">
        <div
          class="d-flex bg-info text-light align-items-center justify-content-center py-2"
        >
          <b-button
            class="d-block mt-4 mx-auto btn-info oh-son"
            size="lg"
            to="/municipality"
            >Повеќе...</b-button
          >
